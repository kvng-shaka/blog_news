			...
			<div id="top-header">
				<div class="container">
					<div class="header-links">
						<ul>
							<li><a href="http://localhost/blog_news/login_page/"><i class="fa fa-sign-in"></i> Login</a></li>
                            <li><a href="http://localhost/blog_news/sign_up_page/"><i class="fa fa-sign-up"></i> Sign Up</a></li>
						</ul>
					</div>
		...
		<div id="owl-carousel-1" class="owl-carousel owl-theme center-owl-nav">
			...
			<article class="article thumb-article">
				<div class="article-img">
					<img src="./image/<?=$rec['image']?>" alt="" width="750px" height="560">
				</div>
				<div class="article-body">
					...
					<h2 class="article-title"><a href="http://localhost/blog_news/post.php"><?=$rec['title']?></a></h2>
					<ul class="article-meta">
						<li><i class="fa fa-clock-o"></i><?=$rec['date_created']?></li>
						<li><i class="fa fa-edits"></i>Posted by:  <?php echo $CurrentUser->getFullname($rec['username']);?></li>
					</ul>
				</div>
			</article>
                <?php }
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-6">
										...
										<article class="article">
											<div class="article-img">
												<a href="post.php?id=<?=$rec['id']?>">
													<img src="./image/<?=$rec['image']?>" alt="" width="262px" height="350">
												</a>
												<ul class="article-info">
													<li class="article-type"><i class="fa fa-camera"></i></li>
												</ul>
											...
											<div class="article-body">
												<h4 class="article-title"><a href="post.php?id=<?=$rec['id']?>"><?=$rec['title']?></a></h4>
												<ul class="article-meta">
													<li><i class="fa fa-clock-o"></i><?=$rec['date_created']?></li>
													<li><i class="fa fa-edits"></i> POSTED BY: <?php echo $CurrentUser->getFullname($rec['username']);?></li>
												</ul>
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-6">
										...
										<article class="article widget-article">
											<div class="article-img">
												<a href="post.php?id=<?=$rec['id']?>">
													<img src="./image/<?=$rec['image']?>" alt="" width="80px" height="80px">
												</a>
											</div>
											<div class="article-body">
												<h4 class="article-title"><a href="post.php?id=<?=$rec['id']?>"><?=$rec['title']?></a></h4>
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6">
								...
								<article class="article">
									<div class="article-img">
										<a href="post.php?id=<?=$rec['id']?>">
											<img src="./image/<?=$rec['image']?>" alt="" width="360px" height="202px">
										</a>
										<ul class="article-info">
											<li class="article-type"><i class="fa fa-camera"></i></li>
										</ul>
									...
									<div class="article-body">
										<h3 class="article-title"><a href="post.php?id=<?=$rec['id']?>"><?=$rec['title']?></a></h3>
										<ul class="article-meta">
											<li><i class="fa fa-clock-o"></i><?=$rec['date_created']?></li>
											<li><i class="fa fa-edits"></i>POSTED BY: <?php echo $CurrentUser->getFullname($rec['username']);?></li>
										</ul>
