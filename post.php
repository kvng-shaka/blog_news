					...
					<div class="col-md-8">
						...
						<article class="article article-post">
							...
							<div class="article-main-img">
								<img src="./image/<?=$user_post['image']?>" alt="" width="750" height="420">
							</div>
							<div class="article-body">
								...
								<h1 class="article-title"><?=$user_post['title']?></h1>
								<ul class="article-meta">
									<li><i class="fa fa-clock-o"></i><?=$user_post['date_created']?></li>
									<li><i class="fa fa-edits"></i>Posted by:  <?php echo $CurrentUser->getFullname($user_post['username']);?></li>
								</ul>
								<p><?=$user_post['body']?></p>
                                <br /><br />
                                <br /><br />
                                <button class="input-btn" ><a href="editpost.php?post_id=<?=$user_post['id']?>"></i>Edit Post</a></button>
                                <button class="input-btn" style="float: right;"><a href="#" onclick="showAlert(<?php echo json_encode($id);?>)"></i>Delete Post</a></button>
							</div>
						</article>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span>
        ...
        <script>
        function showAlert(idno){
            
            var actn = confirm("Do you really want to delete this post?");
            if (actn == true){
